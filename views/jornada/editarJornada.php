    ...
    <form id="MyForm" action="<?php echo URL; ?>jornada/actualizarJornada" method="POST" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-2">
                    <input type="text" class="text-uppercase form-control input-sm"  id="txt_equipoCasa" name="txt_equipoCasa" value='<?php echo $this->datosJornadas[0]['nombre']; ?>'/>
                </div>
                <label for="txt_equipoVisita" class="col-xs-2 control-label">Equipo visita:</label>
                <div class="col-xs-2">
                    <input type="text" class="text-uppercase form-control input-sm"  id="txt_equipoVisita" name="txt_equipoVisita" value='<?php echo $this->datosJornadas[0]['nombre']; ?>'/>
                </div>
            </div> 
            <br><br>
